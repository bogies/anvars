<%@ page contentType="text/html; charset=utf-8" pageEncoding="UTF-8" %>
    <div id="mainright">
        ...
        <div id="editRole" style="width:500px;display: none;z-index:9999999999;position: fixed">
            <div style="padding:20px;">
                <table style="width: 100%">
                    <tr>
                        <th style="height: 40px">角色名:</th>
                        <td>
                            <input type="text" style="width: 200px;border:1px solid #ccc;height: 25px;" ng-model="editRoleInfo.name"
                            />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 200px;border:1px solid #ccc;height: 25px;" ng-model="editRoleInfo.description"
                            />
                        </td>
                    </tr>
                </table>
                ...
                <tr>
                    <td width="340">
                        ...
                        <div class="bw_content1" style="height: 200px;overflow-y: scroll;">
                            ...
                            <ng-pagehelper-bar pagebar-html="${pageContext.request.contextPath}/i/pagebar-simple.html" goto-page="getUnauthUserByRoleId"
                                page-info="unauthRoleUsers"></ng-pagehelper-bar>
                        </div>
                    </td>
                    <td width="80" class="text-center" style="vertical-align: middle;">
                        <a href="javascript:void(0)" ng-click="updateRoleUsers(true)" class="editbtn editbutton editmedium">>></a>
                        <br/>
                        <a href="javascript:void(0)" ng-click="updateRoleUsers(false)" class="editbtn editbutton editmedium">
                            <<</a>
                    </td>
                    <td width="340">
                ...
                <tr>
                    <td width="340">
                        ...
                        <div class="bw_content1" style="height: 380px;overflow-y: scroll;">
                            ...
                            <ng-pagehelper-bar pagebar-html="${pageContext.request.contextPath}/i/pagebar-simple.html" goto-page="getUnauthResByRoleId"
                                page-info="unauthRoleRes"></ng-pagehelper-bar>
                        </div>
                    </td>
                    <td width="80" class="text-center" style="vertical-align: middle;">
                        <a href="javascript:void(0)" ng-click="updateRoleRes(true)" class="editbtn editbutton editmedium">>></a>
                        <br/>
                        <a href="javascript:void(0)" ng-click="updateRoleRes(false)" class="editbtn editbutton editmedium">
                            <<</a>
                    </td>
                    <td width="340">
